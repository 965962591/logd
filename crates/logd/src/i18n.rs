...
pub fn text(key: Key, lang: Language) -> &'static str {
    match (key, lang) {
        ...
        (Key::SaveTat, Language::ZhCn) => "保存 .tat",
        (Key::SaveTat, Language::EnUs) => "Save .tat",
        (Key::SaveEditedCopy, Language::ZhCn) => "保存编辑副本",
        (Key::SaveEditedCopy, Language::EnUs) => "Save Edited Copy",
        (Key::SearchPlaceholder, Language::ZhCn) => "搜索关键字，回车添加",
        (Key::SearchPlaceholder, Language::EnUs) => "Search or press Enter to add",
        (Key::GotoPlaceholder, Language::ZhCn) => "跳转行号",
        (Key::GotoPlaceholder, Language::EnUs) => "Go to line",
        ...
        (Key::EditLine, Language::ZhCn) => "编辑当前行",
        (Key::EditLine, Language::EnUs) => "Edit Line",
