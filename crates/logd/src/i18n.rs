...
pub fn text(key: Key, lang: Language) -> &'static str {
    match (key, lang) {
        ...
        (Key::StartLiveCapture, Language::ZhCn) => "开始 ADB 实时日志采集",
        (Key::StartLiveCapture, Language::EnUs) => "Start ADB logcat capture",
        (Key::StopLiveCapture, Language::ZhCn) => "停止 ADB 实时日志采集",
        (Key::StopLiveCapture, Language::EnUs) => "Stop ADB logcat capture",
        ...
        (Key::FuzzySearch, Language::ZhCn) => "模糊搜索",
        (Key::FuzzySearch, Language::EnUs) => "Fuzzy Search",
        ...
        (Key::ClearLiveLogHistory, Language::ZhCn) => "清除历史实时 Log",
        (Key::ClearLiveLogHistory, Language::EnUs) => "Clear Live Log History",
        ...
        (Key::FilterGroupPlaceholder, Language::ZhCn) => "分组（可选）",
        (Key::FilterGroupPlaceholder, Language::EnUs) => "Group (optional)",
        (Key::Ungrouped, Language::ZhCn) => "未分组",
        (Key::Ungrouped, Language::EnUs) => "Ungrouped",
        ...
        (Key::PreviousFilterMatch, Language::ZhCn) => "上一个匹配日志",
        (Key::PreviousFilterMatch, Language::EnUs) => "Previous matching log",
        (Key::NextFilterMatch, Language::ZhCn) => "下一个匹配日志",
        (Key::NextFilterMatch, Language::EnUs) => "Next matching log",
        ...
        (Key::Marks, Language::ZhCn) => "标记",
        (Key::Marks, Language::EnUs) => "Marks",
        (Key::ShowMarks, Language::ZhCn) => "显示标记",
        (Key::ShowMarks, Language::EnUs) => "Show Marks",
        (Key::HideMarks, Language::ZhCn) => "隐藏标记",
        (Key::HideMarks, Language::EnUs) => "Hide Marks",
        (Key::ToggleMark, Language::ZhCn) => "切换标记",
        (Key::ToggleMark, Language::EnUs) => "Toggle mark",
        (Key::Unmark, Language::ZhCn) => "取消标记",
        (Key::Unmark, Language::EnUs) => "Unmark",
        (Key::NoMarkedLines, Language::ZhCn) => "尚未标记日志行",
        (Key::NoMarkedLines, Language::EnUs) => "No marked log lines",
